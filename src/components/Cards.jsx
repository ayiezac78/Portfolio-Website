...
const rows = [
  ...
  createData(2023, <a className='link link-hover' href="https://adminawrclinic.netlify.app/">Admin Panel for AWR cLinic</a> , <a className='link link-hover' href="https://kodego.ph/">Kodego</a>, "Tailwind CSS • ReactJS • Laravel 9 • Restful API • MySQL, Web Hosting", <a href="https://github.com/ayiezac78/adminclinic.git" target="_blank"><BsGithub/></a>, <a href="https://adminawrclinic.netlify.app/" target='_blank'><BsBoxArrowUpRight/></a>, "It's a full-stack web application for Admin Panel of AWR cLinic that manages patient's online appointment's"),
  createData(2023, <a className='link link-hover' href="https://clinicmp2.netlify.app/">AWR cLinic</a> , <a className='link link-hover' href="https://kodego.ph/">Kodego</a>, "Tailwind CSS • ReactJS • Render Web Services • Restful API • Axios", <a href="https://github.com/ayiezac78/clinic.git" target="_blank"><BsGithub/></a>, <a href="https://clinicmp2.netlify.app/" target='_blank'><BsBoxArrowUpRight/></a>, "It's a front-end API-driven web application that focuses on setting patient's online appointment schedule to the clinic."),
  createData(2023, <a className='link link-hover' href="https://flowerplicity.netlify.app/">Flowerplicity</a> , <a className='link link-hover' href="https://kodego.ph/">Kodego</a>, "Bootstrap 5 • JavaScript • jQuery • CSS • HTML", <a href="https://github.com/ayiezac78/flowerplicity.git" target="_blank"><BsGithub/></a>, <a href="https://flowerplicity.netlify.app/" target='_blank'><BsBoxArrowUpRight/></a>, "It's a static web application that focuses on providing a one-stop-shop for flowers."),
];
