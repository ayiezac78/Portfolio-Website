...
const Hero = () => {
  ...
  return (
    <animated.section style={animation} className="py-10 md:py-32 sm:py-28">
      <div className="grid grid-cols-1 md:grid-cols-2 justify-center place-content-center place-items-center gap-5 md:gap-10 text-white p-5 md:p-10 lg:p-20">
        <div>
          <p className="text-[#324B4C] mb-2 text-lg md:text-xl font-bold">
            Hi, my name is,
          </p>
          <h1 className="text-4xl md:text-7xl text-[#DADDE2] mb-3">
            Ariel Maniago
            <span className="relative lg:right-5 md:right-[21px] sm:right-[10px] blink font-bold">
              |
            </span>
          </h1>
          <h2 className="text-[#324B4C] text-2xl md:text-4xl mb-2">
            Front-end Developer
          </h2>
          <p className="text-[#324B4C] mb-5 text-lg md:text-xl font-bold">
