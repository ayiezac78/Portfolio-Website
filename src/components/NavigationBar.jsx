  ...
  return (
    <div className="navbar w-full fixed top-0 left-0 px-4 z-10 shadow">
      ...
      <div className="flex-none gap-2">
        ...
        <button className="btn btn-sm gap-2 text-[#324B4C] bg-[#ECFEF4] outline outline-1 outline-[#324B4C] hover:border-black hover:bg-transparent dark:hover:bg-[#889FA5] dark:hover:border-white dark:hover:text-[#fff] dark:text-[#324B4C] dark:border-white font-space-mono">
          RESUME
        </button>
      </div>
    </div>
